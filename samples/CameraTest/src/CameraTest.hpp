...
inline constexpr glm::vec3 kCubeRotation = glm::vec3(glm::radians(0.1f), glm::radians(0.2f), glm::radians(-0.3f));
...
inline constexpr glm::vec3 kGridRotation = glm::vec3(glm::radians(91.0f), glm::radians(90.0f), glm::radians(0.0f));
