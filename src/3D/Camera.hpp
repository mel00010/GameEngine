...
class Camera {
 public:
  ...
  void DrawModel(const Renderer& renderer, Model& model,
                 ShaderPrograms shaders = ShaderPrograms::DEFAULT);
  template <typename Renderer>
  void DrawModel(const Renderer& renderer, Cube& cube,
                 ShaderPrograms shaders = ShaderPrograms::CUBE);
  template <typename Renderer>
  void DrawModel(const Renderer& renderer, Skybox& skybox,
                 ShaderPrograms shaders = ShaderPrograms::SKYBOX);
